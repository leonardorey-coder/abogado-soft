  ...
  return (
    <div className="min-h-screen bg-background-light dark:bg-background-dark font-display">
      ...
      <main className="flex w-full flex-1">
        ...
        <div className="hidden lg:flex flex-col justify-center w-1/2 p-16 relative overflow-hidden bg-slate-50 dark:bg-[#101622] border-r border-[#dbdfe6] dark:border-[#2d3748]">
          <div className="relative z-10 w-full max-w-xl mx-auto">
            <div className="bg-primary text-white p-3 rounded-xl mb-6 shadow-lg shadow-primary/20 inline-block">
              <span className="material-symbols-outlined text-[32px] block">app_registration</span>
            </div>
        ...
        <div className="flex-1 flex flex-col justify-center items-center py-12 px-6 bg-white dark:bg-[#1a212f]">
          <div className="w-full max-w-[500px]">
            <div className="flex flex-col mb-8 text-center lg:text-left">
              <h1 className="text-3xl md:text-3xl font-black text-slate-900 dark:text-white leading-tight mb-2">
                Cree su cuenta
              </h1>
            ...
            <div className="bg-transparent border-0 md:bg-white md:dark:bg-slate-800 md:rounded-2xl md:shadow-xl md:border md:border-slate-200 md:dark:border-slate-700 md:p-8 p-4 pt-0">
              ...
              <div className="relative mb-8 flex items-center">
                ...
                <span className="flex-shrink mx-4 text-slate-400 dark:text-slate-500 font-medium text-sm">O regístrese con su correo</span>
                <div className="flex-grow border-t border-slate-200 dark:border-slate-700" />
              </div>
              ...
              <form className="space-y-5" onSubmit={handleSubmit}>
                ...
                <div className="flex flex-col gap-1.5">
                  <label className="text-base font-semibold text-slate-700 dark:text-slate-200">Nombre completo</label>
                ...
                <div className="flex flex-col gap-1.5">
                  <label className="text-base font-semibold text-slate-700 dark:text-slate-200">Correo electrónico</label>
                  <div className="relative group">
                ...
                <div className="flex flex-col gap-1.5">
                  <label className="text-base font-semibold text-slate-700 dark:text-slate-200">Cree una contraseña</label>
                  <div className="relative group">
                    ...
                    <input
                      className="block w-full h-12 pl-12 pr-12 rounded-xl border-2 border-slate-200 dark:border-slate-600 bg-white dark:bg-slate-700 text-slate-900 dark:text-white text-base focus:ring-0 focus:border-primary transition-all placeholder:text-slate-400"
                ...
                <div className="flex flex-col gap-1.5">
                  <label className="text-base font-semibold text-slate-700 dark:text-slate-200">Confirmar contraseña</label>
                  <div className="relative group">
                    <span className="material-symbols-outlined absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 dark:text-slate-500 group-focus-within:text-primary transition-colors">lock</span>
                    <input
                      className="block w-full h-12 pl-12 pr-12 rounded-xl border-2 border-slate-200 dark:border-slate-600 bg-white dark:bg-slate-700 text-slate-900 dark:text-white text-base focus:ring-0 focus:border-primary transition-all placeholder:text-slate-400"
                  ...
                  {confirmPassword.length > 0 && password !== confirmPassword && (
                    <p className="text-sm text-red-600 dark:text-red-400 mt-1">Las contraseñas no coinciden.</p>
                  )}
                </div>
                ...
                <div className="pt-2">
                  <button
                    type="submit"
                    disabled={loading}
                    className="w-full bg-primary hover:bg-primary/90 text-white text-lg font-bold h-14 rounded-xl transition-all transform active:scale-[0.98] shadow-lg shadow-primary/25 flex items-center justify-center gap-2 disabled:opacity-70 disabled:cursor-not-allowed group relative overflow-hidden"
                  >
