...
export const DocumentEditor: React.FC<DocumentEditorProps> = ({ onNavigate }) => {
  ...
  return (
    <div className="bg-background-light dark:bg-background-dark font-display min-h-screen flex flex-col">
      {/* Top Navigation Bar */}
      <header className="flex items-center justify-between whitespace-nowrap border-b border-solid border-[#e7e7f3] dark:border-white/10 bg-white dark:bg-background-dark px-6 py-3 sticky top-0 z-50">
        <div 
        ...
        >
          ...
          <h2 className="text-xl font-bold tracking-tight text-[#0e0e1b] dark:text-white">
            AbogadoSoft
          </h2>
        </div>
        <div className="flex items-center gap-6">
          <div className="flex items-center gap-2 bg-success-green/10 px-4 py-1.5 rounded-full">
            <span className="material-symbols-outlined text-success-green text-lg">
              check_circle
            </span>
            <span className="text-success-green font-bold text-sm">
              Sincronizado
            </span>
          </div>
          <div className="flex items-center gap-3 border-l border-[#e7e7f3] dark:border-white/10 pl-6">
            <button className="size-10 flex items-center justify-center rounded-lg bg-background-light dark:bg-white/5 text-[#0e0e1b] dark:text-white">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm font-semibold text-[#0e0e1b] dark:text-white">
                Dr. Arévalo
              </span>
            </div>
          </div>
