      ...
      <main className="flex w-full flex-1">
        ...
        <div className="flex-1 flex flex-col justify-center items-center py-12 px-6 bg-white dark:bg-[#1a212f]">
          <div className="w-full max-w-[480px]">
            ...
            <div className="bg-transparent border-0 md:bg-white md:dark:bg-slate-800 md:rounded-2xl md:shadow-xl md:border md:border-slate-200 md:dark:border-slate-700 md:p-10 p-4 pt-0">
              <div className="mb-8">
                <button
                  type="button"
              ...
              <form className="space-y-6" onSubmit={handleSubmit}>
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <div className="relative group">
                    ...
                    <input
                      id="login-email"
                      className="block w-full h-14 pl-12 pr-4 rounded-xl border-2 border-slate-200 dark:border-slate-600 bg-white dark:bg-slate-700 text-slate-900 dark:text-white text-lg focus:ring-0 focus:border-primary transition-all placeholder:text-slate-400"
                ...
                <div className="pt-4">
                  <button
                    type="submit"
                    disabled={loading}
                    className="w-full bg-primary hover:bg-primary/90 text-white text-xl font-bold h-14 rounded-xl transition-all transform active:scale-[0.98] shadow-lg shadow-primary/25 flex items-center justify-center gap-2 disabled:opacity-70 disabled:cursor-not-allowed group relative overflow-hidden"
                  >
            ...
            <footer className="mt-8 text-center text-slate-400 dark:text-slate-500 text-sm font-medium">
